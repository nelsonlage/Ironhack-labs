...
-- you will have to identify the correct tables with their primary keys and foreign keys, that will help you get the relevant information.-- -- Using subqueries
-- -- using subqueries
SELECT email
FROM customer
WHERE address_id IN (
